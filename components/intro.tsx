  ...
  return (
    ...
    ref={ref} id="home" className='mb-28 max-w-[50rem] text-center sm:mb-0 scroll-mt-[100rem]'>
        ...
        >
          ...
          <span className="font-bold">Computer Science Major</span> at Florida International University. I enjoy creating{" "}
          <span className="italic">websites, apps, and audio plugins</span>. My focus is on{" "}
          <span className="underline">Software Engineering and Web Development</span>.
        </motion.h1>
