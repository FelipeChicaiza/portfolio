...
export default function Intro() {
  ...
  return (
    ...
    ref={ref} id="home" className='mb-28 max-w-[50rem] text-center sm:mb-0 scroll-mt-[100rem]'>
        ...
        >
  <span className="font-bold">Hello, I&apos;m Felipe.</span> I&apos;m an{" "}
<span className="font-bold">Aspiring Computer Science Major</span> with{" "}
<span className="font-bold">1 year of experience</span>. I enjoy creating{" "}
<span className="italic">websites, apps, and VSTs</span>. My main focus is on{" "}
<span className="underline">Frontend, Backend, and Software Development</span>.
        </motion.h1>
        ...
        >
          ...
          <a
           className='group bg-white px-7 py-3 flex items-center gap-2 rounded-full outline-none focus:scale-110 hover:scale-110 active:scale-105 transition cursor-pointer border border-black/10' href='/Felipe_Chicaiza_Resume.pdf' download
           >
            Download CV{" "}
          ...
          href='https://github.com/FelipeChicaiza' target='_blank'>
            <FaGithubSquare/>
          </a>
        </motion.div>
    </section>
